...
function EditProfilePopup(props) {
  ...
  return (
    <PopupWithForm isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit} title="Редактировать профиль" forSubmit="Сохранить">
      <input onChange={handleSetName} id="user_name" type="text" className="popup__input popup__input_name_name" name="name" minLength="2" maxLength="30" required="" placeholder="Имя" />
      <span id="user_name-error" className="error"></span>
      <input onChange={handleSetDescription} id="about" type="text" className="popup__input popup__input_name_discription" name="discription" required="" minLength="2" maxLength="60" placeholder="О себе" />
